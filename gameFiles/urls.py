...
urlpatterns = [
    ...
    path('who-knows-more-create', views.WhoKnowsMoreCreateView.as_view(), name='who-knows-more-create'),
    ...
    path('who-knows-more-edit/<int:pk>', views.WhoKnowsMoreEditView.as_view(), name='who-knows-more-edit'),
    ...
    path('who-knows-more-delete/<int:pk>', views.WhoKnowsMoreDeleteView.as_view(), name='who-knows-more-delete'),
    ...
    path('who-knows-more-download/<int:category_id>', views.WhoKnowsMoreDownloadView.as_view(), name='who-knows-more-download'),
