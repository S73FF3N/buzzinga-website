...
class SoundTable(dt2.Table):
    select = dt2.CheckBoxColumn(accessor="pk", attrs={"th__input":
                                                          {"onclick": "toggle(this)"},
                                                      "input": {"class": "select_checkbox", "id": print_checkbox_pk,
                                                                "type": "checkbox"}},
...
class WhoKnowsMoreTable(dt2.Table):
    select = dt2.CheckBoxColumn(accessor="pk", attrs={"th__input": {"onclick": "toggle(this)"}, "input": {"class": "select_checkbox", "id": print_checkbox_pk, "type": "checkbox"}},
                                orderable=False)
    edit = dt2.TemplateColumn(template_name='edit_column.html', verbose_name="Ändern")
    delete = dt2.TemplateColumn(template_name='delete_column.html', verbose_name="Löschen")
    solution = dt2.Column(verbose_name="Frage")
    category = dt2.Column(verbose_name="Kategorie")
    difficulty = dt2.Column(verbose_name="Schwierigkeit")
    private_new = dt2.BooleanColumn(verbose_name="Privat")
